...
def read_flight_data():
    file1 = open('/home/jetson/peter/ai-drone/mapped_predictions_log.txt', 'r')
...
#drone.connect_drone('/dev/ttyTHS1') 
drone.connect_drone('/dev/ttyTHS1', True, 921600) 
#drone.set_param('SR2_RAW_CTRL', 30) #change default override frequency
print("param set to: ", drone.get_param('SR2_RAW_CTRL'))
#drone.connect_drone('/dev/ttyTHS1', False, 921600)
